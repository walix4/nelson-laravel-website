    ...
    <section class="citizen-hero relative overflow-hidden text-white">
        <div class="relative mx-auto max-w-7xl px-5 sm:px-8 py-16 lg:py-24">
            ...
            <div class="mt-3 grid lg:grid-cols-12 gap-10 items-center">
                ...
                {{-- Hero photo panel + floating cards (no phone mockup) --}}
                <div class="reveal reveal-right lg:col-span-5">
                    <div class="relative mx-auto max-w-md">
                        <span class="absolute -inset-6 rounded-[36px] blur-3xl bg-red-600/25 pointer-events-none"></span>

                        {{-- Tall framed family photo --}}
                        <div class="relative rounded-[28px] overflow-hidden aspect-[4/5] ring-1 ring-white/15 shadow-[0_30px_80px_-20px_rgba(251,6,6,.45)]">
                            <img src="/images/citizen/family-1.jpg" alt="Family using Auxilio" class="absolute inset-0 w-full h-full object-cover" />
                            <div class="absolute inset-0 bg-gradient-to-t from-navy-950/85 via-navy-950/15 to-transparent"></div>
                            <div class="absolute inset-x-0 bottom-0 p-5">
                                <div class="rounded-md bg-white/10 backdrop-blur ring-1 ring-white/20 px-4 py-3 flex items-center gap-3">
                                    <span class="flex w-9 h-9 items-center justify-center rounded-full bg-emerald-500 text-white">
                                    ...
                                    <div class="leading-tight">
                                        <div class="font-mono text-[9.5px] uppercase tracking-[.18em] text-white/65">Protected</div>
                                        <div class="font-display text-sm font-bold text-white">All 4 family members</div>
                                    </div>
                                </div>
                            </div>
                        </div>

                        {{-- Pulsing SOS ring badge — kept, no phone --}}
                        <div class="hidden md:flex absolute -left-6 top-1/3 items-center justify-center w-16 h-16 rounded-full bg-red-600 text-white shadow-2xl ring-4 ring-red-600/20 z-10">
                        ...
                        <div class="hidden md:flex float-card absolute -right-6 top-12 items-center gap-3 rounded-2xl bg-white px-4 py-3 shadow-2xl ring-1 ring-ink-100 z-10" style="min-width:215px;">
                            <span class="flex w-10 h-10 items-center justify-center rounded-full bg-red-600 text-white shrink-0">
                            ...
                            <div class="leading-tight">
                                <div class="font-mono text-[10px] uppercase tracking-[.18em] text-red-600 font-bold">ALERT · 0.3 mi</div>
                                <div class="font-display text-[14px] font-bold text-navy-900 mt-0.5">Theft · Maple St</div>
                            </div>
                        </div>

                        {{-- RESPONDER card — bottom right --}}
                        <div class="hidden md:flex float-card delay-2 absolute -right-10 bottom-20 items-center gap-3 rounded-2xl bg-navy-900 text-white px-4 py-3 shadow-2xl ring-1 ring-white/10 z-10" style="min-width:215px;">
                            <span class="flex w-10 h-10 items-center justify-center rounded-full bg-emerald-400 text-navy-900 shrink-0">
                                <svg class="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4"/></svg>
                            </span>
                            <div class="leading-tight">
                                <div class="font-mono text-[10px] uppercase tracking-[.18em] text-emerald-400 font-bold">RESPONDER</div>
