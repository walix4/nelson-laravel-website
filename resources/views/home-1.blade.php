                ...
                <div>
                    ...
                    <div class="flex items-center gap-4 mb-2">
                        <div class="flex items-center shrink-0">
                            @foreach(['/images/officer-1.jpg','/images/officer-2.jpg','/images/officer-3.jpg','/images/officer-4.jpg'] as $av)
                            <div style="width:40px;height:40px;border-radius:50%;overflow:hidden;box-shadow:0 0 0 2px rgba(251,191,36,.8);margin-right:-12px;flex-shrink:0;">
                                <img src="{{ $av }}" alt="" style="width:40px;height:40px;object-fit:cover;display:block;" />
                            </div>
                            @endforeach
                            <span style="width:40px;height:40px;border-radius:50%;background:#10b981;display:grid;place-items:center;font-weight:700;font-size:11px;color:#fff;box-shadow:0 0 0 2px rgba(251,191,36,.8);flex-shrink:0;">5K</span>
                        </div>
