...
<div x-data="eaApp()" x-init="init()" x-cloak>
    ...
    {{-- ─── HERO ─── --}}
    <section class="ea-hero-bg relative overflow-hidden" style="min-height:80vh;display:flex;align-items:center;">
