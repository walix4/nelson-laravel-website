            ...
            <div>
                <div>
                    ...
                    <div class="flex items-center gap-4 mb-2">
                        <div class="flex items-center -space-x-3 shrink-0">
                            <img src="/images/officer-1.jpg" alt="" class="w-10 h-10 rounded-full ring-2 ring-amber-400/70 object-cover" />
                            <img src="/images/officer-2.jpg" alt="" class="w-10 h-10 rounded-full ring-2 ring-amber-400/70 object-cover" />
                            <img src="/images/officer-3.jpg" alt="" class="w-10 h-10 rounded-full ring-2 ring-amber-400/70 object-cover" />
                            <img src="/images/officer-4.jpg" alt="" class="w-10 h-10 rounded-full ring-2 ring-amber-400/70 object-cover" />
                            <span class="w-10 h-10 grid place-items-center rounded-full ring-2 ring-amber-400/70 bg-emerald-500 text-white font-bold text-[11px]">5K</span>
                        </div>
                    ...
                    <div class="p-4">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="flex justify-between mt-1.5 text-[9px] font-mono uppercase tracking-wider">
                                <span :class="inc.pct >= 5  ? 'text-red-600' : 'text-slate-300'">Report</span>
                                <span :class="inc.pct >= 25 ? 'text-red-600' : 'text-slate-300'">Dispatch</span>
                                <span :class="inc.pct >= 50 ? 'text-red-600' : 'text-slate-300'">Route</span>
                                <span :class="inc.pct >= 75 ? 'text-red-600' : 'text-slate-300'">Scene</span>
                                <span :class="inc.pct >= 100? 'text-red-600' : 'text-slate-300'">Closed</span>
                            </div>
                        </div>
