...
<div x-data="eaApp()" x-init="init()" x-cloak>
    ...
    <section class="ea-hero-bg relative overflow-hidden" style="min-height:90vh;display:flex;align-items:center;">
        ...
        <div class="hidden md:block" style="position:absolute;right:8%;top:50%;transform:translateY(-50%);width:clamp(360px,24vw,450px);height:clamp(360px,24vw,450px);pointer-events:none;z-index:0;">
            <div class="ea-circle-badge absolute inset-0 ring-4 ring-white/20 flex items-center justify-center" style="background:rgba(251,6,6,.55);">
                ...
                <span class="ea-circle-badge absolute inset-8 animate-ping opacity-30" style="background:rgba(251,6,6,.55); animation-delay:.6s;"></span>
                <span class="relative font-display font-extrabold text-white tracking-[.22em]" style="font-size:clamp(34px,3vw,46px);">ALERT</span>
            </div>
