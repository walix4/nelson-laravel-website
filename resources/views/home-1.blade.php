                    ...
                    <div class="p-5">
                        ...
                        <div class="flex items-center justify-between gap-2">
                            <div class="flex items-center -space-x-2">
                                <img src="/images/officer-1.jpg" alt="" class="w-8 h-8 rounded-full ring-2 ring-white object-cover" style="border-radius:9999px;" />
                                <img src="/images/officer-2.jpg" alt="" class="w-8 h-8 rounded-full ring-2 ring-white object-cover" style="border-radius:9999px;" />
                                <img src="/images/officer-3.jpg" alt="" class="w-8 h-8 rounded-full ring-2 ring-white object-cover" style="border-radius:9999px;" />
                                <span class="w-8 h-8 rounded-full bg-slate-900 ring-2 ring-white text-white font-bold text-[10px] grid place-items-center" style="border-radius:9999px;" x-text="`+${inc.officers}`"></span>
                            </div>
