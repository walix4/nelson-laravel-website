...
<div data-view="how-it-works" class="hidden">
    ...
    <section class="relative bg-navy-950 overflow-hidden">
        ...
        <div class="relative mx-auto max-w-3xl px-5 sm:px-8 py-20 lg:py-28 text-center text-white">
            ...
            <h3 class="reveal reveal-delay-1 mt-6 font-display text-3xl sm:text-4xl lg:text-5xl tracking-tight">
            ...
            <p class="reveal reveal-delay-2 mt-4 text-base text-navy-200/80 max-w-xl mx-auto leading-relaxed">
