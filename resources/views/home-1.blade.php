...
<section id="cg-hero-section" class="relative overflow-hidden" style="min-height:90vh;display:flex;align-items:center;background:radial-gradient(ellipse at 18% -10%,rgba(255,255,255,.5) 0%,transparent 55%),radial-gradient(ellipse at 90% 110%,rgba(13,90,30,.55) 0%,transparent 55%),linear-gradient(160deg,#34d058 0%,#22A620 44%,#1c8a1a 72%,#15691a 100%)">
    ...
    <div class="hidden md:block" style="position:absolute;left:40px;top:50%;transform:translateY(-50%);width:300px;height:300px;opacity:.16;pointer-events:none;z-index:0">
...
<div x-data="eaApp()" x-init="init()" x-cloak>
    ...
    <section class="ea-hero-bg relative overflow-hidden" style="min-height:90vh;display:flex;align-items:center;">
        ...
        {{-- radar art --}}
        <div class="ea-radar-wrap absolute left-6 lg:left-16 top-1/2 -translate-y-1/2 pointer-events-none z-0 hidden md:block" style="width:320px;height:320px;opacity:.5;">
