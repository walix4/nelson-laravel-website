...
{{-- =======================================================================
     CHOOSE YOUR AUXILIO — interactive Citizen / Agent tabs
========================================================================--}}
<section class="relative py-20 lg:py-28 overflow-hidden" style="background: linear-gradient(160deg, #060f30 0%, #0a1a4a 45%, #0d1f56 70%, #061229 100%);">
    <div class="pointer-events-none absolute inset-0 opacity-[.07]" style="background-image: linear-gradient(rgba(140,180,255,.7) 1px, transparent 1px), linear-gradient(90deg, rgba(140,180,255,.7) 1px, transparent 1px); background-size: 56px 56px; mask-image: radial-gradient(ellipse at center, black 0%, transparent 75%);"></div>
    <span class="pointer-events-none absolute -top-20 -left-10 w-[460px] h-[460px] rounded-full blur-3xl" style="background:radial-gradient(circle,rgba(56,189,248,.30) 0%,transparent 70%);"></span>
    <span class="pointer-events-none absolute bottom-0 right-0 w-[500px] h-[500px] rounded-full blur-3xl" style="background:radial-gradient(circle,rgba(99,102,241,.32) 0%,transparent 70%);"></span>

    <div class="relative mx-auto max-w-6xl px-5 sm:px-8 text-white">
        <div class="text-center max-w-2xl mx-auto">
            <p class="reveal text-xs font-semibold uppercase tracking-[.2em]" style="color:#7dd3fc;">Choose your Auxilio</p>
            <h2 class="reveal reveal-delay-1 mt-3 font-display font-extrabold text-3xl sm:text-4xl lg:text-[52px] leading-[1.05] tracking-tight text-white">
                One platform. <span style="background:linear-gradient(90deg,#38bdf8 0%,#818cf8 60%,#a5b4fc 100%); -webkit-background-clip:text; background-clip:text; color:transparent;">Two apps.</span>
            </h2>
            <p class="reveal reveal-delay-2 mt-4 text-white/65">Tap a tab to see what each app does.</p>
        </div>

        {{-- Tabs --}}
        <div class="reveal reveal-delay-3 mt-10 flex justify-center" data-home-tabs>
            <div class="inline-flex rounded-full p-1.5 ring-1 ring-white/15" style="background:rgba(255,255,255,.05); backdrop-filter:blur(10px);">
                <button type="button" data-home-tab="citizen" class="home-tab is-active inline-flex items-center gap-2 rounded-full px-6 py-2.5 text-sm font-semibold transition" style="color:#fff;">
                    <svg class="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M16 11a4 4 0 10-8 0 4 4 0 008 0zM3 21a7 7 0 0118 0"/></svg>
                    For Citizens
                </button>
                <button type="button" data-home-tab="agent" class="home-tab inline-flex items-center gap-2 rounded-full px-6 py-2.5 text-sm font-semibold transition text-white/65 hover:text-white">
                    <svg class="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M12 2l8 4v6c0 5-3.5 9-8 10-4.5-1-8-5-8-10V6l8-4z"/></svg>
                    For Officers
                </button>
            </div>
        </div>
        ...
        {{-- Tab content --}}
        <div class="reveal reveal-delay-4 mt-12 relative" data-home-panels>
            {{-- CITIZEN panel --}}
            <div data-home-panel="citizen" class="grid lg:grid-cols-12 gap-8 items-center">
                <div class="lg:col-span-7 space-y-3">
                    @foreach ([
                        ['t'=>'Live SOS to dispatch','d'=>'One tap reaches a verified responder in under 30 seconds.','c'=>'#38bdf8'],
                        ['t'=>'Family circle','d'=>'See your loved ones safe at home, school, or in transit.','c'=>'#818cf8'],
                        ['t'=>'Live crime map','d'=>'Hyperlocal alerts — only what affects your block.','c'=>'#22c55e'],
                        ['t'=>'Sex offender registry','d'=>'Always-on overlay of public registries on your map.','c'=>'#f59e0b'],
                    ] as $f)
                        <div class="group flex items-center gap-4 rounded-2xl p-4 transition-all duration-300 hover:translate-x-1" style="background:rgba(255,255,255,.04); box-shadow: inset 0 0 0 1px rgba(255,255,255,.06);">
                            <span class="flex w-11 h-11 items-center justify-center rounded-xl text-white shrink-0 shadow-lg" style="background:linear-gradient(135deg,{{ $f['c'] }}, {{ $f['c'] }}cc);">
                                <svg class="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4"><path stroke-linecap="round" stroke-linejoin="round" d="M5 12l5 5L20 7"/></svg>
                            </span>
                            <div class="flex-1">
                                <p class="font-display font-bold text-white">{{ $f['t'] }}</p>
                                <p class="text-sm text-white/60">{{ $f['d'] }}</p>
                            </div>
                            <svg class="w-5 h-5 text-white/30 opacity-0 -translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-300" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7"/></svg>
                        </div>
                    @endforeach
                    <a data-route href="#/citizen-app" class="mt-3 inline-flex items-center gap-2 rounded-full px-6 py-3 text-sm font-semibold text-white transition hover:-translate-y-0.5" style="background:linear-gradient(135deg,#0ea5e9,#6366f1); box-shadow: 0 14px 30px -10px rgba(14,165,233,.55);">
                        Open Citizen app
                ...
                <div class="lg:col-span-5">
                    <div class="relative mx-auto max-w-sm rounded-3xl overflow-hidden aspect-[4/5] ring-1 ring-white/15 shadow-2xl">
                        <img src="/images/citizen/cartoon-family-3d.jpg" alt="Citizen app" class="absolute inset-0 w-full h-full object-cover" />
                        <div class="absolute inset-0 bg-gradient-to-t from-navy-950/80 via-transparent to-transparent"></div>
                        <div class="absolute bottom-4 left-4 right-4 text-white">
                            <p class="text-[10px] font-mono uppercase tracking-[.18em] text-white/70">Auxilio Citizen</p>
                            <p class="mt-1 font-display text-lg font-bold">Free, forever for families.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            {{-- AGENT panel --}}
            <div data-home-panel="agent" class="hidden grid lg:grid-cols-12 gap-8 items-center">
                <div class="lg:col-span-7 space-y-3">
                    @foreach ([
                        ['t'=>'1-tap accept dispatch','d'=>'Triage, accept and lock in a call without typing.','c'=>'#38bdf8'],
                        ['t'=>'Live turn-by-turn','d'=>'Routed to the incident with full backup awareness.','c'=>'#818cf8'],
                        ['t'=>'Encrypted officer channel','d'=>'Squad chat that survives spotty signal.','c'=>'#22c55e'],
                        ['t'=>'Offline incident capture','d'=>'Photos, notes, audio — sync when the network returns.','c'=>'#f59e0b'],
                    ] as $f)
                        <div class="group flex items-center gap-4 rounded-2xl p-4 transition-all duration-300 hover:translate-x-1" style="background:rgba(255,255,255,.04); box-shadow: inset 0 0 0 1px rgba(255,255,255,.06);">
                            <span class="flex w-11 h-11 items-center justify-center rounded-xl text-white shrink-0 shadow-lg" style="background:linear-gradient(135deg,{{ $f['c'] }}, {{ $f['c'] }}cc);">
                                <svg class="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4"><path stroke-linecap="round" stroke-linejoin="round" d="M5 12l5 5L20 7"/></svg>
                    ...
                    @endforeach
                    <a data-route href="#/agent-app" class="mt-3 inline-flex items-center gap-2 rounded-full px-6 py-3 text-sm font-semibold text-white transition hover:-translate-y-0.5" style="background:linear-gradient(135deg,#0ea5e9,#6366f1); box-shadow: 0 14px 30px -10px rgba(14,165,233,.55);">
                        Open Agent app
                        <svg class="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4"><path stroke-linecap="round" stroke-linejoin="round" d="M5 12h14m0 0l-6-6m6 6l-6 6"/></svg>
                    </a>
                </div>
                <div class="lg:col-span-5">
                    <div class="relative mx-auto max-w-sm rounded-3xl overflow-hidden aspect-[4/5] ring-1 ring-white/15 shadow-2xl">
                        <img src="/images/officer-hero.jpg" alt="Agent app" class="absolute inset-0 w-full h-full object-cover object-top" />
                        <div class="absolute inset-0 bg-gradient-to-t from-navy-950/80 via-transparent to-transparent"></div>
                        <div class="absolute bottom-4 left-4 right-4 text-white">
                            <p class="text-[10px] font-mono uppercase tracking-[.18em] text-white/70">Auxilio Agente</p>
                            <p class="mt-1 font-display text-lg font-bold">The badge in your pocket.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <style>
        [data-home-tabs] .home-tab.is-active { background: linear-gradient(135deg,#0ea5e9,#6366f1); color: #fff; box-shadow: 0 10px 24px -10px rgba(14,165,233,.6); }
    </style>
    <script>
        (function(){
            ...
            tabs.forEach(function(btn){
                btn.addEventListener('click', function(){
                    ...
                    tabs.forEach(function(t){ t.classList.toggle('is-active', t === btn); t.classList.toggle('text-white/65', t !== btn); });
                    panels.forEach(function(p){ p.classList.toggle('hidden', p.getAttribute('data-home-panel') !== key); });
                });
            });
        })();
    </script>
