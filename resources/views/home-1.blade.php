        ...
        <div class="lg:col-span-6 relative">
            <div class="reveal reveal-right relative mx-auto max-w-xl">
                ...
                <div class="hidden md:flex absolute -right-6 top-8 items-center gap-3 rounded-2xl bg-white px-4 py-3 shadow-2xl ring-1 ring-ink-100 z-10" style="min-width:215px; animation: floatY 6s ease-in-out infinite;">
                    <span class="flex w-11 h-11 items-center justify-center rounded-full text-white shrink-0" style="background:#0ea5e9;">
                    ...
                    <div class="leading-tight">
                        <div class="font-mono text-[10px] uppercase tracking-[.18em] font-bold" style="color:#0ea5e9;">ALERT · 0.3 MI</div>
...
<div data-view="auxilio-ai" class="hidden">
    ...
    <section class="relative overflow-hidden py-16 lg:py-20" style="background:linear-gradient(180deg,#050b22,#0a1a4a 50%,#050b22);">
        ...
        <style>
            ...
            [data-view="auxilio-ai"] .aux-tab-btn { padding: 8px 18px; border-radius: 9999px; font-size: 13px; font-weight: 600; cursor: pointer; background:rgba(255,255,255,0.07); color:rgba(255,255,255,0.65); border:1px solid rgba(255,255,255,0.12); transition: all .18s ease; display:inline-flex; align-items:center; gap:6px; }
            ...
            [data-view="auxilio-ai"] .aux-crime-btn { padding: 6px 14px; border-radius: 9999px; font-size: 12px; font-weight:500; cursor: pointer; background:rgba(255,255,255,0.07); color:rgba(255,255,255,0.6); border:1px solid rgba(255,255,255,0.12); transition: all .15s ease; }
    ...
    <section class="relative py-16 lg:py-20 overflow-hidden text-white" style="background:linear-gradient(160deg, #050d2a 0%, #0a1a4a 50%, #061229 100%);">
        ...
        <div class="relative mx-auto max-w-5xl px-5 sm:px-8">
            ...
            <div class="mt-12 text-center">
                <a href="#" data-open-chat class="inline-flex items-center gap-2 rounded-full px-6 py-3 text-sm font-semibold text-white transition hover:-translate-y-0.5" style="background:linear-gradient(135deg,#0ea5e9,#6366f1); box-shadow: 0 14px 30px -10px rgba(14,165,233,.55);">
                    Try Auxilio AI now
                    <svg class="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4"><path stroke-linecap="round" stroke-linejoin="round" d="M5 12h14m0 0l-6-6m6 6l-6 6"/></svg>
                </a>
            </div>
