...
<div id="chat-dialog" role="dialog" aria-modal="false" aria-labelledby="chat-title"
    ...
    {{-- White toolbar: Contact / Chat history / New chat --}}
    <div class="flex items-center justify-center gap-2 px-3 py-2 bg-white border-b border-ink-100">
    ...
    {{-- Messages --}}
    <div id="chat-thread" class="flex-1 overflow-y-auto px-4 py-5 space-y-4 bg-white relative">
        <div id="chat-empty" class="text-center px-6 py-10">
            <div class="mx-auto mb-3 grid place-items-center w-12 h-12 rounded-full" style="background:#dbeafe;">
                <svg class="w-6 h-6" style="color:#1e3a8a;" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M12 3v3m0 12v3M3 12h3m12 0h3M5.6 5.6l2.1 2.1m8.6 8.6l2.1 2.1M5.6 18.4l2.1-2.1m8.6-8.6l2.1-2.1"/></svg>
            </div>
            <p class="font-semibold text-navy-900">Ask Auxilio AI anything</p>
            <p class="mt-1 text-[13px] text-ink-500">Public safety info, app help, account questions.</p>
        </div>
    </div>

    {{-- Composer — rounded grey input + blue paper plane --}}
    <form id="chat-form" class="flex items-center gap-2 px-3 py-3 bg-white border-t border-ink-100">
        <div class="relative flex-1">
            <input id="chat-input" type="text" autocomplete="off" placeholder="Ask me anything..." class="w-full pl-4 pr-12 py-2.5 text-sm rounded-full bg-ink-50 border border-ink-100 focus:outline-none focus:border-blue-400 focus:bg-white focus:ring-2 focus:ring-blue-100"/>
            <button type="submit" class="absolute top-1/2 -translate-y-1/2 right-1.5 grid place-items-center w-9 h-9 rounded-full text-white" style="background:#1e3a8a;" aria-label="Send">
