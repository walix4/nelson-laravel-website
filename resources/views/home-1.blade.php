...
<div data-view="citizen-app" class="hidden">
    <style>
        [data-view="citizen-app"] .citizen-hero {
            background:
                radial-gradient(circle at 20% 20%, rgba(251,6,6,.18), transparent 55%),
                radial-gradient(circle at 80% 30%, rgba(245,200,68,.16), transparent 50%),
                linear-gradient(180deg, #0a1224 0%, #0c1730 55%, #0a1224 100%);
        }
        ...
        [data-view="citizen-app"] .citizen-counter {
            font-variant-numeric: tabular-nums;
        }
        [data-view="citizen-app"] [data-faq-item][data-open] [data-faq-icon] {
    ...
    <section class="citizen-hero relative overflow-hidden text-white">
        <div class="relative mx-auto max-w-7xl px-5 sm:px-8 py-16 lg:py-24">
            ...
            <div class="mt-3 grid lg:grid-cols-12 gap-10 items-center">
                <div class="lg:col-span-7">
                    <span class="reveal reveal-delay-1 inline-flex items-center gap-2 rounded-full bg-white/10 ring-1 ring-white/15 backdrop-blur text-white text-xs font-bold uppercase tracking-wider px-3 py-1.5">
                        ...
                        Auxilio Citizen · iOS & Android
                    </span>
                    <h1 class="reveal reveal-delay-2 mt-5 font-display font-extrabold text-4xl sm:text-5xl lg:text-6xl tracking-tight">
                        Your safety, <br/>
                        <span style="color:#FB0606">your control.</span>
                    </h1>
                    <p class="reveal reveal-delay-3 mt-5 text-lg text-white/75 max-w-xl">
                    ...
                    <div class="reveal reveal-delay-4 mt-8 grid grid-cols-1 sm:grid-cols-2 gap-3" style="max-width:380px;">
                        <a href="#" class="group inline-flex items-center justify-center gap-3 rounded-md bg-red-600 hover:bg-red-700 text-white px-5 py-3.5 shadow-lg hover:shadow-red-600/30 transition">
                            <img src="/images/app-store.svg" alt="" class="w-7 h-7 shrink-0" />
                            <div class="text-left whitespace-nowrap leading-tight">
                                <p class="text-[10px] uppercase tracking-wider text-white/80">Download on the</p>
                                <p class="text-sm font-semibold -mt-0.5">App Store</p>
                        ...
                        <a href="#" class="group inline-flex items-center justify-center gap-3 rounded-md bg-white text-navy-900 hover:bg-white/90 px-5 py-3.5 shadow-lg transition">
                            <img src="/images/google-play.svg" alt="" class="w-7 h-7 shrink-0" />
                            <div class="text-left whitespace-nowrap leading-tight">
                                <p class="text-[10px] uppercase tracking-wider text-navy-500">Get it on</p>
                                <p class="text-sm font-semibold -mt-0.5">Google Play</p>
                            </div>
                        </a>
                    </div>
                ...
                <div class="reveal reveal-right lg:col-span-5">
                    <div class="relative mx-auto max-w-[280px]">
                        <span class="absolute -inset-6 rounded-full blur-3xl bg-red-600/20 pointer-events-none"></span>
                        <div class="relative aspect-[9/19] rounded-[40px] bg-navy-950 p-3 shadow-[0_30px_80px_-20px_rgba(251,6,6,.4)]">
                            <div class="absolute top-5 left-1/2 -translate-x-1/2 w-20 h-5 rounded-full bg-navy-950 z-20"></div>
                            <div class="relative w-full h-full rounded-[30px] overflow-hidden bg-white">
                                <img src="/images/screen-sos.png" alt="Auxilio Citizen — SOS" class="absolute inset-0 w-full h-full object-cover object-top" />
                            </div>
                        </div>

                        {{-- Pulsing SOS ring badge --}}
                        <div class="hidden md:flex absolute -left-12 top-20 items-center justify-center w-14 h-14 rounded-full bg-red-600 text-white shadow-2xl z-10">
                        ...
                        <div class="hidden md:flex float-card absolute -right-16 top-16 items-center gap-2.5 rounded-md bg-white px-3 py-2.5 shadow-2xl border border-white/30 z-10" style="min-width:200px;">
                            <span class="flex w-8 h-8 items-center justify-center rounded-full bg-emerald-100 text-emerald-700">
                                <svg class="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4M12 22s8-7.5 8-13a8 8 0 10-16 0c0 5.5 8 13 8 13z"/></svg>
                            </span>
                            <div>
                                <div class="font-mono text-[9px] uppercase tracking-[.16em] text-emerald-700 font-bold">FAMILY SAFE</div>
                                <div class="font-display text-[12px] font-semibold text-navy-900 leading-tight">All 4 members at home</div>
                            </div>
                        </div>

                        <div class="hidden md:flex float-card delay-1 absolute -left-20 bottom-24 items-center gap-2.5 rounded-md bg-navy-900 text-white px-3 py-2.5 shadow-2xl ring-1 ring-white/10 z-10" style="min-width:200px;">
                            <span class="flex w-8 h-8 items-center justify-center rounded-full bg-red-600 text-white">
                                <svg class="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4"><path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3.75M2.7 16.13c-.87 1.5.22 3.37 1.95 3.37h14.7c1.73 0 2.82-1.87 1.95-3.37L13.95 3.38c-.87-1.5-3.03-1.5-3.9 0L2.7 16.13z"/></svg>
                            </span>
                            <div>
                                <div class="font-mono text-[9px] uppercase tracking-[.16em] text-red-400 font-bold">ALERT · 0.3mi</div>
                                <div class="font-display text-[12px] font-semibold leading-tight">Theft reported · Maple St</div>
                            </div>
                        </div>

                        <div class="hidden md:flex float-card delay-2 absolute -right-12 bottom-8 items-center gap-2.5 rounded-md bg-white text-navy-900 px-3 py-2.5 shadow-2xl border border-white/30 z-10" style="min-width:190px;">
                            <span class="flex w-8 h-8 items-center justify-center rounded-full bg-amber-100 text-amber-700">
                                <svg class="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4"><path stroke-linecap="round" stroke-linejoin="round" d="M12 22s8-7.5 8-13a8 8 0 10-16 0c0 5.5 8 13 8 13z"/><circle cx="12" cy="9" r="2.5"/></svg>
                            </span>
                            <div>
                                <div class="font-mono text-[9px] uppercase tracking-[.16em] text-amber-700 font-bold">RESPONDER</div>
                                <div class="font-display text-[12px] font-semibold leading-tight">Officer Reyes · 90s</div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            {{-- Trust marquee --}}
            <div class="reveal mt-16 overflow-hidden">
    ...
    <section class="relative bg-ink-50">
        <div class="mx-auto max-w-7xl px-5 sm:px-8 py-20 lg:py-28">
            <div class="reveal rounded-[28px] bg-white shadow-xl ring-1 ring-ink-100 p-6 sm:p-10 lg:p-14">
                <div class="grid lg:grid-cols-12 gap-10 lg:gap-14 items-center">
                    <div class="lg:col-span-5">
                        <div class="relative">
                            <div class="relative rounded-[22px] overflow-hidden aspect-[4/5] shadow-lg">
                                <img src="/images/citizen/family-2.jpg" alt="Family using Auxilio" class="absolute inset-0 w-full h-full object-cover" />
                                <div class="absolute inset-0 bg-gradient-to-t from-navy-950/40 via-transparent to-transparent"></div>
                            </div>
                            <div class="absolute -bottom-5 left-4 right-4 rounded-md bg-white px-4 py-3 shadow-2xl ring-1 ring-ink-100 flex items-center gap-3">
                                <span class="flex w-9 h-9 items-center justify-center rounded-full bg-emerald-100 text-emerald-700">
                                    <svg class="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4"/></svg>
                                </span>
                                <div>
                                    <div class="font-display text-sm font-bold text-navy-900">Help on the way</div>
                                    <div class="text-[12px] text-ink-500">Responder dispatched · ETA 1m 48s</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="lg:col-span-7">
                        ...
                        <h2 class="reveal reveal-delay-1 mt-3 font-display font-extrabold text-3xl sm:text-4xl lg:text-5xl tracking-tight text-navy-900">
                            Loved by folks in over <span class="text-brand-600">thirty cities.</span>
                        </h2>
                        <p class="reveal reveal-delay-2 mt-5 text-navy-700/80 leading-relaxed max-w-xl">
                            Auxilio is the safety companion families count on every day. From your child's walk home to your parents' late-night drive — we keep you connected, informed, and one tap away from real help.
                        </p>
                        <a data-route href="#/about" class="reveal reveal-delay-3 mt-7 inline-flex items-center gap-2 rounded-full border-2 border-brand-500 text-brand-600 hover:bg-brand-50 px-6 py-2.5 text-sm font-semibold transition">
                            About Auxilio
                        ...
                        <dl data-citizen-stats class="mt-10 grid grid-cols-2 gap-x-10 gap-y-8">
                            @foreach ([
                                ['v'=>500,'suffix'=>'K+','l'=>'Active Citizens Protected'],
            ...
            <div class="reveal mt-14 grid lg:grid-cols-3 gap-5">
                ...
                <div class="space-y-5">
                    <article class="relative overflow-hidden rounded-[22px] bg-white ring-1 ring-ink-100 shadow-md p-7 min-h-[420px] flex flex-col">
                        ...
                        <div class="mt-6 relative flex items-end justify-end">
                            <div class="relative w-[180px] aspect-[9/19] rounded-[28px] bg-navy-950 p-2 shadow-xl">
                                <div class="absolute top-3 left-1/2 -translate-x-1/2 w-12 h-3 rounded-full bg-navy-950 z-20"></div>
                                <div class="relative w-full h-full rounded-[22px] overflow-hidden bg-emerald-50">
                                    <img src="/images/screen-home.png" alt="Citizen home" class="absolute inset-0 w-full h-full object-cover object-top" />
                                </div>
                            </div>
                        </div>
                    </article>
    ...
    <section class="relative bg-ink-50">
        <div class="mx-auto max-w-7xl px-5 sm:px-8 py-20 lg:py-28">
            ...
            <div class="reveal mt-14 grid lg:grid-cols-12 gap-12 items-start">
                <div class="lg:col-span-5">
                    <div class="relative mx-auto max-w-[300px] lg:sticky lg:top-28">
                        <span class="absolute -inset-6 rounded-full blur-3xl bg-brand-100/60 pointer-events-none"></span>
                        <div class="relative aspect-[9/19] rounded-[40px] bg-navy-950 p-3 shadow-[0_30px_80px_-20px_rgba(12,17,38,.5)]">
                            <div class="absolute top-5 left-1/2 -translate-x-1/2 w-20 h-5 rounded-full bg-navy-950 z-20"></div>
                            <div class="relative w-full h-full rounded-[30px] overflow-hidden bg-white">
                                <img data-citizen-step-img src="/images/screen-companion.png" alt="Step" class="absolute inset-0 w-full h-full object-cover object-top transition-opacity duration-300" />
                            </div>
                        </div>
                ...
                <div class="lg:col-span-7">
                    <ol data-citizen-steps class="relative space-y-2">
                        @foreach ([
                            ['n'=>'01','img'=>'/images/screen-companion.png','h'=>'Create your free Citizen profile','b'=>"Just your name, phone, and a 4-digit PIN. We never sell your data — and the citizen tier is free, forever."],
                            ['n'=>'02','img'=>'/images/screen-location.png','h'=>'Verify your phone in 30 seconds','b'=>"Standard SMS verification. Once verified, you'll receive trusted, ranked alerts and never spam."],
                            ['n'=>'03','img'=>'/images/screen-home.png','h'=>'Add your family circle','b'=>'Invite parents, partner, kids — share location in either direction with one-tap controls.'],
                            ['n'=>'04','img'=>'/images/screen-sos.png','h'=>"You're protected — go live the day",'b'=>"SOS is wired up, alerts are flowing, your family knows where you are when you want them to."],
                        ] as $i => $s)
    ...
    <section class="relative overflow-hidden bg-navy-950 text-white">
        <div class="absolute inset-0 pointer-events-none">
            <div class="absolute -top-32 -left-20 w-[420px] h-[420px] rounded-full bg-red-600/25 blur-3xl"></div>
            <div class="absolute -bottom-32 -right-10 w-[480px] h-[480px] rounded-full bg-gold-400/15 blur-3xl"></div>
        </div>
        <div class="relative mx-auto max-w-7xl px-5 sm:px-8 py-20 lg:py-28">
            <div class="grid lg:grid-cols-12 gap-10 items-center">
                <div class="lg:col-span-7">
                    <p class="reveal text-xs font-mono uppercase tracking-[.2em] text-red-400">Stop scrolling, start safe</p>
                    <h2 class="reveal reveal-delay-1 mt-4 font-display font-extrabold text-3xl sm:text-4xl lg:text-5xl tracking-tight">
                        Download Auxilio — and never <br/>
                        <span style="color:#FB0606">walk alone</span> again.
                    </h2>
                    <p class="reveal reveal-delay-2 mt-5 max-w-xl text-white/75 leading-relaxed">
                        Free for citizens. Encrypted by default. Live in 30+ cities. Your family's new safety net is one tap away.
                    </p>
                    <div class="reveal reveal-delay-3 mt-8 flex flex-col sm:flex-row gap-3" style="max-width:420px;">
                        <a href="#" class="flex-1 inline-flex items-center justify-center gap-3 rounded-md bg-red-600 hover:bg-red-700 text-white px-5 py-3.5 shadow-lg hover:shadow-red-600/30 transition">
                            <img src="/images/app-store.svg" alt="" class="w-7 h-7 shrink-0" />
                            <div class="text-left whitespace-nowrap leading-tight">
                                <p class="text-[10px] uppercase tracking-wider text-white/80">Download on the</p>
                                <p class="text-sm font-semibold -mt-0.5">App Store</p>
                        ...
                        <a href="#" class="flex-1 inline-flex items-center justify-center gap-3 rounded-md bg-white text-navy-900 hover:bg-white/90 px-5 py-3.5 shadow-lg transition">
                            <img src="/images/google-play.svg" alt="" class="w-7 h-7 shrink-0" />
                            <div class="text-left whitespace-nowrap leading-tight">
                                <p class="text-[10px] uppercase tracking-wider text-navy-500">Get it on</p>
                                <p class="text-sm font-semibold -mt-0.5">Google Play</p>
                ...
                <div class="lg:col-span-5">
                    <div class="reveal reveal-right relative max-w-md mx-auto">
                        <div class="relative rounded-[28px] overflow-hidden aspect-[4/5] ring-1 ring-white/10 shadow-2xl">
                            <img src="/images/citizen/family-cartoon.jpg" alt="Family" class="absolute inset-0 w-full h-full object-cover" />
                            <div class="absolute inset-0 bg-gradient-to-t from-navy-950/85 via-navy-950/30 to-transparent"></div>
                            <div class="absolute bottom-5 left-5 right-5">
                                <div class="rounded-md bg-white/10 backdrop-blur ring-1 ring-white/15 px-4 py-3 flex items-center gap-3">
                                    <span class="flex w-9 h-9 items-center justify-center rounded-full bg-red-600 text-white">
                                    ...
                                    <div class="leading-tight">
                                        <div class="font-mono text-[9.5px] uppercase tracking-[.18em] text-white/60">Protected</div>
                                        <div class="font-display text-sm font-bold">All 4 family members</div>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    (function(){
        ...
        if (stepsRoot) {
            ...
            function go(n) {
                ...
                if (img) {
                    var src = steps[i].getAttribute('data-img');
                    img.style.opacity = '0';
