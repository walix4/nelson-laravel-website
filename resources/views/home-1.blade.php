...
<section id="cg-hero-section" class="relative overflow-hidden" style="min-height:540px;background:radial-gradient(ellipse at 18% -10%,rgba(255,255,255,.5) 0%,transparent 55%),radial-gradient(ellipse at 90% 110%,rgba(13,90,30,.55) 0%,transparent 55%),linear-gradient(160deg,#34d058 0%,#22A620 44%,#1c8a1a 72%,#15691a 100%)">
    ...
    <div class="hidden md:block" style="position:absolute;right:40px;top:50%;transform:translateY(-50%);width:300px;height:300px;opacity:.16;pointer-events:none;z-index:0">
        ...
        <div class="relative mx-auto max-w-7xl px-5 sm:px-8 pt-16 sm:pt-20 lg:pt-24 pb-20 lg:pb-28 grid lg:grid-cols-12 gap-10 lg:gap-14 items-center">
            ...
            <div class="lg:col-span-6 order-2 lg:order-1 relative">
                <div class="reveal reveal-right relative mx-auto max-w-xl">
                    ...
                    {{-- main mockup box --}}
                    <div class="relative rounded-[32px] overflow-hidden aspect-square ring-1 ring-white/15 scifi-glow-cyan scifi-corner ai-phone-slide-wrap" style="background:#f0f4ff; box-shadow: 0 40px 90px -20px rgba(8,15,40,.7);">
                        <style>
                            ...
                            .ai-phone-slide { position:absolute; inset:0; width:100%; height:100%; object-fit:contain; opacity:0; will-change:opacity; }
                            .ai-phone-slide:nth-child(1) { animation: aiPhoneSlide 8s ease-in-out infinite; animation-delay:0s; opacity:1; }
                            .ai-phone-slide:nth-child(2) { animation: aiPhoneSlide 8s ease-in-out infinite; animation-delay:4s; }
                        </style>
                        ...
                        {{-- HUD ticker overlay --}}
                        <div class="absolute top-3 left-3 right-3 z-[3] flex items-center justify-between scifi-mono text-[9px] text-cyan-800/70">
                        ...
                        {{-- bottom HUD strip --}}
                        <div class="absolute bottom-3 left-3 right-3 z-[3] rounded-lg px-3 py-2 flex items-center gap-2" style="background:rgba(7,23,48,0.75);">
                    ...
                    <div class="flex items-center gap-5">
                        <div>
                            <div class="flex items-baseline gap-2.5">
                                ...
                                <span class="ea-pulse-dot w-2.5 h-2.5 rounded-full bg-red-600 self-center"></span>
                            </div>
                            <p class="text-[11px] font-bold uppercase tracking-[.2em] text-red-700 mt-2">Active Incidents Now</p>
                        </div>
                        <div class="h-14 w-px" style="background:rgba(10,26,74,.22)"></div>
                        <div>
                            <div class="font-mono text-2xl font-bold" style="color:#0a1a4a" x-text="liveTime">--:--:--</div>
