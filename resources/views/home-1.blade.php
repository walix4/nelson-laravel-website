...
{{-- ── HERO ── --}}
<section id="cg-hero-section" class="relative overflow-hidden" style="min-height:80vh;background:radial-gradient(ellipse at 18% -10%,rgba(255,255,255,.5) 0%,transparent 55%),radial-gradient(ellipse at 90% 110%,rgba(13,90,30,.55) 0%,transparent 55%),linear-gradient(160deg,#34d058 0%,#22A620 44%,#1c8a1a 72%,#15691a 100%)">
...
<div x-data="eaApp()" x-init="init()" x-cloak>
    ...
    {{-- ─── HERO ─── --}}
    <section class="ea-hero-bg relative overflow-hidden" style="min-height:80vh;">
