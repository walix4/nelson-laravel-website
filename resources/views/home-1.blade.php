...
<header data-nav style="background-color:#0a1a4a" class="fixed inset-x-0 top-0 z-50 text-white">
    <nav class="mx-auto flex h-[78px] max-w-7xl items-center px-5 sm:px-8">
        ...
        <ul class="hidden lg:flex flex-1 items-center justify-end gap-5 xl:gap-6 text-sm font-medium text-white/80 whitespace-nowrap">
            ...
            <li class="flex items-center gap-2 pl-4 ml-2 border-l border-white/20">
                <a href="https://auxilionetwork.com/siteadmin/login"    target="_blank" rel="noopener" class="inline-flex items-center justify-center px-4 py-2 text-xs font-bold text-white rounded transition hover:opacity-85" style="background:#FB0606;">Sign In</a>
                <a href="https://auxilionetwork.com/siteadmin/register" target="_blank" rel="noopener" class="inline-flex items-center justify-center px-4 py-2 text-xs font-bold rounded border border-white/40 text-white hover:bg-white hover:text-[#0a1a4a] transition">Get Started</a>
            </li>
        </ul>

        {{-- Hamburger — shown on mobile + tablet (below lg) --}}
        <div class="lg:hidden ml-auto">
            <button data-menu-btn aria-expanded="false" aria-controls="mobile-menu" class="relative w-10 h-10 grid place-items-center rounded-lg hover:bg-white/10 transition">
...
<div data-view="auxilio-ai" class="hidden">
    ...
    <section class="relative overflow-hidden py-16 lg:py-20 text-white" style="background:linear-gradient(180deg,#050b22 0%,#0a1a4a 50%,#050b22 100%);">
        ...
        <div class="relative mx-auto max-w-7xl px-5 sm:px-8">
            ...
            @php
                $auxFeats = [
                    ['t'=>'Live AI-powered crime maps','i'=>'M9 6l-6 2v12l6-2 6 2 6-2V6l-6 2-6-2zM9 6v12m6-10v12'],
                    ['t'=>'Real-time emergency alerts','i'=>'M15 17h5l-1.4-1.4A2 2 0 0118 14V11a6 6 0 10-12 0v3a2 2 0 01-.6 1.6L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9'],
                    ['t'=>'Registered offender notifications','i'=>'M12 9v3.75m0 3.75h.01M2.7 16.13c-.87 1.5.22 3.37 1.95 3.37h14.7c1.73 0 2.82-1.87 1.95-3.37L13.95 3.38c-.87-1.5-3.03-1.5-3.9 0L2.7 16.13z'],
                    ['t'=>'One-tap panic & SOS system','i'=>'M21 12a9 9 0 11-18 0 9 9 0 0118 0zM9 9l6 6m0-6l-6 6'],
                    ['t'=>'Verified responder network','i'=>'M12 3l8 4v5c0 5-3.5 8.5-8 9-4.5-.5-8-4-8-9V7l8-4z'],
                    ['t'=>'Smart location-based monitoring','i'=>'M12 22s8-7.5 8-13a8 8 0 10-16 0c0 5.5 8 13 8 13z'],
                    ['t'=>'AI threat detection & risk analysis','i'=>'M12 3v3m0 12v3M3 12h3m12 0h3M5.6 5.6l2.1 2.1m8.6 8.6l2.1 2.1M5.6 18.4l2.1-2.1m8.6-8.6l2.1-2.1'],
                    ['t'=>'Family protection & safety zones','i'=>'M16 11a4 4 0 10-8 0 4 4 0 008 0zM3 21a7 7 0 0118 0'],
                    ['t'=>'Real-time incident tracking','i'=>'M12 8v4l3 2m6-2a9 9 0 11-18 0 9 9 0 0118 0z'],
                    ['t'=>'Community safety intelligence','i'=>'M17 20h5v-2a4 4 0 00-3-3.87M9 20H4v-2a4 4 0 013-3.87m6-10a4 4 0 11-8 0 4 4 0 018 0zm6 3a3 3 0 11-6 0 3 3 0 016 0z'],
                    ['t'=>'Secure cloud-based infrastructure','i'=>'M3 15a4 4 0 014-4h1a5 5 0 019.9-1.5A4.5 4.5 0 0119 18H5a3 3 0 01-2-3z'],
