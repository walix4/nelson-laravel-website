...
<style>
  ...
  .est-ref{font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-weight:700;font-size:13px;letter-spacing:-0.03em;color:rgba(11,35,80,0.82);max-width:84px;display:inline-block;line-height:1.4;}
  .est-table td:nth-child(1){max-width:96px;}
  ...
  .est-cust .est-name{font-weight:700;max-width:170px;line-height:1.35;}
  .est-sub{font-size:13px;color:var(--muted);margin-top:3px;}
  .est-route{display:flex;align-items:center;gap:8px;font-weight:600;}
  .est-arrow{flex:0 0 auto;display:inline-block;}
  .est-loc{max-width:150px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;}
  .est-chip{display:inline-block;font-size:12px;font-weight:700;padding:4px 11px;border-radius:8px;background:#fff;border:1px solid rgba(11,35,80,0.14);color:var(--navy);white-space:nowrap;}
  .est-badge{display:inline-flex;align-items:center;gap:6px;font-size:12.5px;font-weight:700;padding:6px 13px;border-radius:999px;white-space:nowrap;}
  ...
  .est-prog{width:110px;}
  .est-prog-track{height:8px;border-radius:8px;background:rgba(11,35,80,0.09);overflow:hidden;}
  .est-prog-fill{height:100%;border-radius:8px;background:linear-gradient(90deg,#3A5FC0,#6E8FE0);transition:width .7s cubic-bezier(.4,0,.2,1);box-shadow:0 0 10px rgba(58,95,192,0.5);}
  .est-prog-label{font-size:12px;font-weight:600;color:var(--muted);margin-top:6px;}
  .est-calc{font-style:italic;color:var(--muted);}
  .est-price{font-weight:800;font-size:17px;color:var(--navy);}
  .est-time{display:inline-flex;align-items:center;gap:6px;color:var(--muted);font-size:14px;white-space:nowrap;}
  .est-view{display:inline-flex;align-items:center;gap:6px;color:var(--red);font-weight:700;font-size:14px;text-decoration:none;white-space:nowrap;padding:7px 13px;border-radius:8px;transition:background .15s;}
...
<script>
  ...
  const UP_ARROW='<svg class="est-arrow" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#16B571" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 19V5M5 12l7-7 7 7"/></svg>';
  const DOWN_ARROW='<svg class="est-arrow" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#FF3B30" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 5v14M5 12l7 7 7-7"/></svg>';
  ...
  function estRow(e){return '<tr><td><span class="est-ref">'+e.ref+'</span></td>'+
    ...
    '<td><div class="est-route">'+UP_ARROW+'<span class="est-loc">'+e.pickup+'</span></div><div class="est-sub" style="padding-left:26px">'+e.pickupSub+'</div></td>'+
    '<td><div class="est-route">'+DOWN_ARROW+'<span class="est-loc">'+e.drop+'</span></div><div class="est-sub" style="padding-left:26px">'+e.dropSub+'</div></td>'+
