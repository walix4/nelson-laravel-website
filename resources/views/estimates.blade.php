...
<style>
  ...
  .est-pin{display:inline-flex;align-items:center;justify-content:center;width:24px;height:24px;border-radius:7px;flex:0 0 auto;}
...
<script>
  ...
  function estRow(e){return '<tr><td><span class="est-ref">'+e.ref+'</span></td>'+
    ...
    '<td><div class="est-route">'+UP_ARROW+'<span class="est-loc">'+e.pickup+'</span></div><div class="est-sub" style="padding-left:32px">'+e.pickupSub+'</div></td>'+
    '<td><div class="est-route">'+DOWN_ARROW+'<span class="est-loc">'+e.drop+'</span></div><div class="est-sub" style="padding-left:32px">'+e.dropSub+'</div></td>'+
