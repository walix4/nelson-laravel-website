...
export default function ToolLayout({ eyebrow = "DrayChain tool", title, desc, children }: { eyebrow?: string; title: React.ReactNode; desc: string; children: React.ReactNode }) {
  return (
    <>
      <Nav />
      <RevealInit />
