...
export default function ToolLayout({ eyebrow = "Drayage Blockchain tool", title, desc, children }: { eyebrow?: string; title: React.ReactNode; desc: string; children: React.ReactNode }) {
  return (
    <>
      <Nav />
      <RevealInit />
