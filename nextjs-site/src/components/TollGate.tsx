    ...
    <div className="tg-wrap">
      <svg viewBox="0 0 360 320" width="100%" style={{ maxWidth: 440, overflow: "visible" }} role="img" aria-label="Toll gate">
        <defs>
          ...
          <linearGradient id="tgOrange" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stopColor="#3bb8ee" /><stop offset="1" stopColor="#00a2e7" /></linearGradient>
          <linearGradient id="tgOrangeDark" x1="0" y1="0" x2="1" y2="0"><stop offset="0" stopColor="#0086c2" /><stop offset="1" stopColor="#0086c2" /></linearGradient>
          <radialGradient id="tgGlow" cx="0.5" cy="0.5" r="0.5"><stop offset="0" stopColor="#00a2e7" stopOpacity="0.5" /><stop offset="1" stopColor="#00a2e7" stopOpacity="0" /></radialGradient>
          <pattern id="tgStripes" width="22" height="14" patternUnits="userSpaceOnUse" patternTransform="rotate(20)"><rect width="22" height="14" fill="#00a2e7" /><rect width="11" height="14" fill="#FFFFFF" /></pattern>
        </defs>
        ...
        <circle cx="264" cy="99" r="4.5" fill="#00a2e7" />
        ...
        <circle cx="252" cy="229" r="5" fill="#00a2e7" />
      </svg>
