...
export default function PageHero({ eyebrow, title, sub, photo, children }: { eyebrow: string; title: React.ReactNode; sub: string; photo?: string; children?: React.ReactNode }) {
  return (
    <section className="relative overflow-hidden text-white">
      ...
      <div className="absolute inset-0" style={{ background: photo ? "linear-gradient(180deg,rgba(4,12,30,0.88),rgba(6,20,46,0.82))" : "radial-gradient(900px 500px at 70% 0%,rgba(58,95,192,0.3),transparent 60%),linear-gradient(180deg,#07153B,#0B2D5C)" }} />
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 py-20 md:py-28">
        <div className="max-w-3xl">
          <div className="inline-flex items-center gap-2 rounded px-3.5 py-1.5 text-[11px] font-semibold uppercase tracking-[0.16em]" style={{ background: "rgba(47,97,192,0.18)", border: "1px solid rgba(110,143,224,0.45)" }}>
