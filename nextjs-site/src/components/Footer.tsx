        ...
        <div className="grid md:grid-cols-[1.5fr_1fr_1fr_1fr] gap-10 mb-12">
          <div>
            ...
            <div className="flex flex-row gap-2 mt-5 flex-wrap">
              <a href="#" className="inline-flex items-center gap-2 rounded-lg h-[38px] pl-2.5 pr-3 bg-white/[0.10] hover:bg-white/[0.20] border border-white/15 transition-colors duration-200">
                <svg width="18" height="18" viewBox="0 0 384 512" fill="#fff" className="shrink-0"><path d="M318.7 268.7c-.2-36.7 16.4-64.4 50-84.8-18.8-26.9-47.2-41.7-84.7-44.6-35.5-2.8-74.3 20.7-88.5 20.7-15 0-49.4-19.7-76.4-19.7C63.3 141.2 4 184.8 4 273.5q0 39.3 14.4 81.2c12.8 36.7 59 126.7 107.2 125.2 25.2-.6 43-17.9 75.8-17.9 31.8 0 48.3 17.9 76.4 17.9 48.6-.7 90.4-82.5 102.6-119.3-65.2-30.7-61.7-90-61.7-91.9zm-56.6-164.2c27.3-32.4 24.8-61.9 24-72.5-24.1 1.4-52 16.4-67.9 34.9-17.5 19.8-27.8 44.3-25.6 71.9 26.1 2 49.9-11.4 69.5-34.3z"/></svg>
                <span className="leading-none text-white text-left"><span className="block text-[7px] opacity-70">Download on the</span><span className="block text-[11px] font-semibold tracking-tight">App Store</span></span>
              </a>
              <a href="#" className="inline-flex items-center gap-2 rounded-lg h-[38px] pl-2.5 pr-3 bg-white/[0.10] hover:bg-white/[0.20] border border-white/15 transition-colors duration-200">
                <img src={asset("/google-play.png")} alt="" className="h-[18px] w-auto shrink-0" />
                <span className="leading-none text-white text-left"><span className="block text-[7px] uppercase tracking-[0.12em] opacity-70">Get it on</span><span className="block text-[11px] font-semibold tracking-tight">Google Play</span></span>
              </a>
            </div>
          </div>
