...
const REVIEWS: R[] = [
  { n: "Marcus Powell", r: 5, d: "May 06, 2026", img: 12, t: "Best compliance tool we've used. We finally dispatch knowing every axle is legal — instead of guessing and getting a fine at the scale." },
  { n: "Terry McCarty", r: 5, d: "May 05, 2026", img: 13, t: "Honestly the cleanest overweight checker out there. Love it." },
  { n: "Ben Wallace", r: 5, d: "Apr 28, 2026", img: 33, t: "Just started using it and so far so good. The per-axle numbers matched the certified scale almost to the pound. That kind of accuracy matters when you run heavy daily." },
  { n: "Talia Bennett", r: 5, d: "Apr 23, 2026", img: 45, t: "Quick, accurate, dependable. Exactly what our dispatch desk needed." },
  { n: "Marie Barker", r: 5, d: "Apr 08, 2026", img: 5, t: "We'd be lost without this. Thank you Dray Overweight — you've taken the guesswork out of every permit decision we make." },
  { n: "Tom Riggs", r: 5, d: "Mar 12, 2026", img: 51, t: "The app works very well and the web version is even better. Checking a load against state limits takes seconds now." },
  { n: "Jarred Herman", r: 5, d: "Jan 10, 2026", img: 8, t: "The bridge-formula check paid for itself in a week. It showed exactly which axle group was over and how to redistribute before we rolled." },
  { n: "Betty Sue Sands", r: 5, d: "Nov 22, 2025", img: 23, t: "Great people to work with and a genuinely useful product." },
  { n: "Hector Ramos", r: 5, d: "Nov 03, 2025", img: 60, t: "Cut our permit-prep time in half. Having every state's overweight rules in one place is the part I didn't know I needed." },
  { n: "Dana Liu", r: 5, d: "Oct 18, 2025", img: 32, t: "Solid tool for over-the-road. Coverage keeps growing and the new state permit rule sets are filling in fast." },
  { n: "Owen Pratt", r: 5, d: "Sep 30, 2025", img: 14, t: "The axle-distribution and clearance flags are scary accurate. Great for setting customer expectations up front." },
  { n: "Sofia Marin", r: 5, d: "Sep 12, 2025", img: 47, t: "Switched our whole fleet over. Permit fees and escort triggers in the analysis is a game changer." },
];
