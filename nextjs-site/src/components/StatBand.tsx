const STATS = [
  { n: "$0", l: "Hidden fees, ever", i: '<rect x="5" y="3" width="14" height="18" rx="1.5"/><path d="M9 7h2M13 7h2M9 11h2M13 11h2M9 15h2M13 15h2M9 21v-3h6v3"/>' },
  { n: "Instant", l: "Payouts to carriers & drivers", i: '<path d="M3 6h13v9H3zM16 9h3l2 3v3h-5zM6 18a1.6 1.6 0 1 0 0-3.2A1.6 1.6 0 0 0 6 18Zm12 0a1.6 1.6 0 1 0 0-3.2A1.6 1.6 0 0 0 18 18Z"/>' },
  { n: "100%", l: "On-chain transaction records", i: '<rect x="3" y="7" width="18" height="10" rx="1"/><path d="M7 7v10M11 7v10M15 7v10"/>' },
  { n: "99.9%", l: "Platform uptime SLA", i: '<path d="M12 3l7 3v5c0 4.5-3 8-7 10-4-2-7-5.5-7-10V6z"/><path d="M9.5 12l1.8 1.8L15 10"/>' },
];
