...
const COSTS = [
  { n: "Toll roads", d: "Live per-mile rates × tolled miles × your axle class.", i: '<path d="M12 2a7 7 0 0 0-7 7c0 4.6 5.7 11.5 6.2 12.1a1 1 0 0 0 1.6 0C13.3 20.5 19 13.6 19 9a7 7 0 0 0-7-7Zm0 9.5A2.5 2.5 0 1 1 12 6.5a2.5 2.5 0 0 1 0 5Z"/>', a: "#00a2e7" },
  ...
  { n: "Congestion & peak", d: "Time-of-day, express-lane and managed-lane pricing.", i: '<path d="M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20Zm1 9.6 2.7 1.55a1 1 0 1 1-1 1.74l-3.2-1.85A1 1 0 0 1 11 12V7a1 1 0 1 1 2 0v4.6Z"/>', a: "#00a2e7" },
        ...
        <div className="relative z-10 max-w-[1400px] mx-auto px-6 py-16 md:py-24">
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-14 items-center">
            ...
            <div className="flex flex-col justify-center">
              ...
              <h1 className="display text-white text-[40px] md:text-[64px] leading-[1.02]"><span className="italic font-black" style={{ fontFamily: "'Roboto', sans-serif" }}>DrayPay</span> <span className="bg-gradient-to-r from-[#8fd9f5] via-[#3bb8ee] to-[#00a2e7] bg-clip-text text-transparent">Smart Wallet</span><span className="block">Digital Wallet for Drayage</span></h1>
