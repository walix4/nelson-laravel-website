          ...
          <div className="grid lg:grid-cols-[440px_1fr] gap-10 lg:gap-14 items-stretch">
            ...
            <div className="flex flex-col justify-center h-full">
              ...
              <div className="mt-8 flex flex-wrap items-center gap-3">
                {/* App Store badge */}
                <a href="#" className="inline-flex items-center gap-2.5 rounded-md px-4 py-2 transition hover:brightness-110" style={{ background: "rgba(255,255,255,0.14)", border: "1px solid rgba(255,255,255,0.32)", backdropFilter: "blur(12px)", WebkitBackdropFilter: "blur(12px)", boxShadow: "inset 0 1px 0 rgba(255,255,255,0.3)" }}>
                  ...
                  <span className="leading-none text-white text-left"><span className="block text-[9.5px] opacity-90">Download on the</span><span className="block text-[16px] font-semibold mt-0.5 tracking-tight">App Store</span></span>
                </a>
                {/* Google Play badge */}
                <a href="#" className="inline-flex items-center gap-2.5 rounded-md px-4 py-2 transition hover:brightness-110" style={{ background: "rgba(255,255,255,0.14)", border: "1px solid rgba(255,255,255,0.32)", backdropFilter: "blur(12px)", WebkitBackdropFilter: "blur(12px)", boxShadow: "inset 0 1px 0 rgba(255,255,255,0.3)" }}>
                  <svg width="20" height="20" viewBox="0 0 512 512" aria-hidden="true"><path fill="#00C3FF" d="M50 40 268 256 50 472z"/><path fill="#00E676" d="M50 40 390 186 268 256z"/><path fill="#FF3D00" d="M50 472 390 326 268 256z"/><path fill="#FFD600" d="M390 186 470 256 390 326 268 256z"/></svg>
                  <span className="leading-none text-white text-left"><span className="block text-[9px] uppercase tracking-[0.14em] opacity-90">Get it on</span><span className="block text-[16px] font-semibold mt-0.5 tracking-tight">Google Play</span></span>
                </a>
              </div>
