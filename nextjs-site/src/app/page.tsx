...
const COSTS = [
  { n: "Gross vehicle weight", d: "Total GVW checked against the 80,000 lb federal limit and state caps.", i: '<path d="M12 2a7 7 0 0 0-7 7c0 4.6 5.7 11.5 6.2 12.1a1 1 0 0 0 1.6 0C13.3 20.5 19 13.6 19 9a7 7 0 0 0-7-7Zm0 9.5A2.5 2.5 0 1 1 12 6.5a2.5 2.5 0 0 1 0 5Z"/>', a: "#ffde01" },
  { n: "Federal Bridge Formula", d: "Axle spacing and group weights run through the bridge formula.", i: '<path d="M12 3a10 10 0 0 0-10 9 1 1 0 0 0 1 1h1v6h2v-6h3v6h2v-6h2v6h2v-6h3v6h2v-6h1a1 1 0 0 0 1-1A10 10 0 0 0 12 3Z"/>', a: "#3A5FC0" },
  { n: "Per-axle limits", d: "Single, tandem and tridem axle limits checked group by group.", i: '<path d="M3 7a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1h2.4a2 2 0 0 1 1.72.98l1.6 2.67A2 2 0 0 1 24 12.7V15a1 1 0 0 1-1 1h-1.2a3 3 0 0 1-5.6 0H9.8a3 3 0 0 1-5.6 0H3a1 1 0 0 1-1-1V7Zm14 3h4l-1.2-2H17v2ZM7 18.5A1.5 1.5 0 1 0 7 15.5a1.5 1.5 0 0 0 0 3Zm10 0a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z"/>', a: "#ffde01" },
  { n: "State permits & fees", d: "Per-state overweight permit thresholds, fees and validity.", i: '<path d="M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20Zm1 9.6 2.7 1.55a1 1 0 1 1-1 1.74l-3.2-1.85A1 1 0 0 1 11 12V7a1 1 0 1 1 2 0v4.6Z"/>', a: "#ffde01" },
  { n: "Escort & route restrictions", d: "Pilot-car triggers, low bridges and weight-restricted roads.", i: '<path d="M3 6a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v1H3V6Zm0 4h18v8a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-8Zm3 5a1 1 0 1 0 0 2h5a1 1 0 1 0 0-2H6Z"/>', a: "#1E3A8A" },
  { n: "Fines & penalties", d: "Estimated overweight fine exposure if you roll without a permit.", i: '<path d="M2 7a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V7Zm10 1.5A3.5 3.5 0 1 0 12 15.5a3.5 3.5 0 0 0 0-7ZM5.5 8A1.5 1.5 0 0 0 4 9.5a1 1 0 0 0 2 0A1.5 1.5 0 0 0 5.5 8Zm13 5a1.5 1.5 0 0 0-1.5 1.5 1 1 0 0 0 2 0 1.5 1.5 0 0 0-.5-1.5Z"/>', a: "#ffde01" },
];
  ...
  return (
    <>
      ...
      <section className="py-24 relative overflow-hidden" style={{ background: "linear-gradient(180deg,#FFFFFF,#EEF4F9)" }}>
        <div className="max-w-[1400px] mx-auto px-6 relative">
          <div className="text-center max-w-2xl mx-auto reveal">
            ...
            <h2 className="display text-[40px] md:text-[52px] text-[var(--navy)] leading-[1.04] mt-2">Loads being checked right now</h2>
            <p className="mt-4 text-[var(--muted)] text-[15px]">Real overweight checks running across the country this minute — by axle configuration, from 5-axle semis to oversize permit loads.</p>
            <div className="mt-6 flex items-center justify-center gap-4"><Link href="/estimates" className="text-[14px] font-semibold text-[var(--navy)] inline-flex items-center gap-1.5">View all <Arrow /></Link><Link href="/#quote" className="px-5 py-2.5 rounded-lg text-[13px] font-semibold bg-[var(--navy)] text-white hover:bg-[var(--navy-2)] transition">Check a load</Link></div>
          </div>
        ...
        <div className="max-w-[1400px] mx-auto px-6 relative">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="reveal">
              <div className="text-[11px] uppercase tracking-[0.18em] font-semibold text-[var(--red)]">Every variable, checked.</div>
              <h2 className="display text-[40px] md:text-[52px] leading-[1.04] mt-2">The model behind every compliance call.</h2>
              <p className="text-white/65 mt-5 max-w-lg text-[15px]">Axle count, gross weight, axle spacing, height, width, length and route — every input feeds the compliance engine so you know if a load is legal before it leaves the yard. No guesswork, no surprise at the scale house.</p>
              <div className="mt-8 grid grid-cols-2 gap-3 max-w-lg">
                {[["State rule sets", "50"], ["Compliance inputs", "38"], ["Recheck latency", "120ms"], ["Limit refresh", "Daily"]].map(([k, v]) => <div key={k} className="glass-dark rounded-xl p-4"><div className="text-white/55 text-[10px] uppercase tracking-wider">{k}</div><div className="display num text-[24px] mt-1">{v}</div></div>)}
              </div>
            </div>
            <div className="relative flex items-center justify-center" style={{ minHeight: 480 }}>
              ...
              <div className="floating-tag glass-dark rounded-xl px-3 py-2 text-[11px]" style={{ top: "8%", left: "5%", animationDelay: "-1s" }}><div className="text-white/55 text-[9px] uppercase tracking-wider">Axle config</div><div className="display text-white">5-axle semi</div></div>
              <div className="floating-tag glass-dark rounded-xl px-3 py-2 text-[11px]" style={{ top: "20%", right: "5%", animationDelay: "-2.5s" }}><div className="text-white/55 text-[9px] uppercase tracking-wider">Gross weight</div><div className="display text-white num">38,420 lb</div></div>
              <div className="floating-tag glass-dark rounded-xl px-3 py-2 text-[11px]" style={{ bottom: "18%", left: "8%", animationDelay: "-3.5s" }}><div className="text-white/55 text-[9px] uppercase tracking-wider">Status</div><div className="display text-white">Legal</div></div>
              <div className="floating-tag glass-dark rounded-xl px-3 py-2 text-[11px]" style={{ bottom: "8%", right: "6%", animationDelay: "-1.5s" }}><div className="text-white/55 text-[9px] uppercase tracking-wider">States</div><div className="display text-white num">3</div></div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 relative overflow-hidden" style={{ background: "linear-gradient(180deg,#F8FAFC,#EEF2F8)" }}>
        <div className="absolute inset-0 opacity-50 pointer-events-none" style={{ background: "radial-gradient(800px 400px at 80% 10%,rgba(58,95,192,0.18),transparent 60%),radial-gradient(700px 400px at 10% 80%,rgba(255,222,1,0.13),transparent 60%)" }} />
        <div className="max-w-[1400px] mx-auto px-6 relative">
          <div className="max-w-2xl reveal"><div className="text-[11px] uppercase tracking-[0.18em] font-semibold text-[var(--red)]">Overweight transparency</div><h2 className="display text-[40px] md:text-[48px] text-[var(--navy)] leading-[1.05] mt-2">Every compliance factor, accounted for.</h2><p className="mt-4 text-[var(--muted)] text-[15px]">No surprise at the scale house. No fine weeks later. Six compliance factors on every analysis — checked against current state and federal limits.</p></div>
          ...
          <div className="ports-band flex flex-col md:block">
            ...
            <div className="ports-card left">
              ...
              <div className="grid grid-cols-2 gap-3 mb-5">
                <div className="pf-radio"><span className="pf-dot" />Permits</div>
                <div className="pf-radio sel"><span className="pf-dot" />Axle limits</div>
                <div className="pf-radio"><span className="pf-dot" />Escorts</div>
              </div>
