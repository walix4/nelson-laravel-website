          ...
          <div className="grid lg:grid-cols-[440px_1fr] gap-10 lg:gap-14 items-stretch">
            ...
            <div className="flex flex-col justify-center h-full">
              ...
              <div className="mt-8 flex flex-wrap items-center gap-3">
                {/* App Store badge */}
                <a href="#" className="inline-flex items-center gap-3 rounded-md px-5 py-2.5 transition hover:brightness-110" style={{ background: "rgba(255,255,255,0.14)", border: "1px solid rgba(255,255,255,0.32)", backdropFilter: "blur(12px)", WebkitBackdropFilter: "blur(12px)", boxShadow: "inset 0 1px 0 rgba(255,255,255,0.3)" }}>
                  <svg width="27" height="27" viewBox="0 0 384 512" fill="#fff" aria-hidden="true"><path d="M318.7 268.7c-.2-36.7 16.4-64.4 50-84.8-18.8-26.9-47.2-41.7-84.7-44.6-35.5-2.8-74.3 20.7-88.5 20.7-15 0-49.4-19.7-76.4-19.7C63.3 141.2 4 184.8 4 273.5q0 39.3 14.4 81.2c12.8 36.7 59 126.7 107.2 125.2 25.2-.6 43-17.9 75.8-17.9 31.8 0 48.3 17.9 76.4 17.9 48.6-.7 90.4-82.5 102.6-119.3-65.2-30.7-61.7-90-61.7-91.9zm-56.6-164.2c27.3-32.4 24.8-61.9 24-72.5-24.1 1.4-52 16.4-67.9 34.9-17.5 19.8-27.8 44.3-25.6 71.9 26.1 2 49.9-11.4 69.5-34.3z"/></svg>
                  <span className="leading-none text-white text-left"><span className="block text-[11px] opacity-90">Download on the</span><span className="block text-[20px] font-semibold mt-1 tracking-tight">App Store</span></span>
                </a>
                {/* Google Play badge */}
                <a href="#" className="inline-flex items-center gap-3 rounded-md px-5 py-2.5 transition hover:brightness-110" style={{ background: "rgba(255,255,255,0.14)", border: "1px solid rgba(255,255,255,0.32)", backdropFilter: "blur(12px)", WebkitBackdropFilter: "blur(12px)", boxShadow: "inset 0 1px 0 rgba(255,255,255,0.3)" }}>
                  <svg width="24" height="24" viewBox="0 0 512 512" aria-hidden="true"><path fill="#00C3FF" d="M50 40 268 256 50 472z"/><path fill="#00E676" d="M50 40 390 186 268 256z"/><path fill="#FF3D00" d="M50 472 390 326 268 256z"/><path fill="#FFD600" d="M390 186 470 256 390 326 268 256z"/></svg>
                  <span className="leading-none text-white text-left"><span className="block text-[10px] uppercase tracking-[0.14em] opacity-90">Get it on</span><span className="block text-[20px] font-semibold mt-1 tracking-tight">Google Play</span></span>
                </a>
              </div>
