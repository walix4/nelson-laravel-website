          ...
          <div className="grid lg:grid-cols-[440px_1fr] gap-10 lg:gap-14 items-stretch">
            ...
            <div className="flex flex-col justify-center h-full">
              ...
              <div className="mt-8 flex flex-wrap items-center gap-3">
                {/* App Store badge */}
                <a href="#" className="inline-flex items-center gap-3 rounded-xl px-5 py-2.5 transition hover:brightness-110" style={{ background: "rgba(18,22,30,0.6)", border: "1px solid rgba(255,255,255,0.18)", backdropFilter: "blur(4px)" }}>
