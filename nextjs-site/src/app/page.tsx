          ...
          <div className="grid lg:grid-cols-[440px_1fr] gap-10 lg:gap-14 items-stretch">
            ...
            <div className="flex flex-col justify-center h-full">
              ...
              <div className="mt-8 flex flex-wrap items-center gap-3">
                {/* App Store badge */}
                <a href="#" className="inline-flex items-center justify-center gap-2 rounded-md h-[48px] w-[150px] transition hover:brightness-110" style={{ background: "rgba(255,255,255,0.2)", border: "1px solid rgba(255,255,255,0.09)", backdropFilter: "blur(12px)", WebkitBackdropFilter: "blur(12px)" }}>
