                  ...
                  <tr key={e.ref}>
                    <td>
                      <div className="est-refcell">
                        ...
                        {e.container === "reefer"
                          ? <svg className="est-ico" style={{ color: "#2E8BE6" }} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2v20M2 12h20M5 5l14 14M19 5L5 19" /><path d="M12 5l-2.2 2.2M12 5l2.2 2.2M12 19l-2.2-2.2M12 19l2.2 2.2M5 12l2.2-2.2M5 12l2.2 2.2M19 12l-2.2-2.2M19 12l-2.2 2.2" /></svg>
                          : <svg className="est-ico" style={{ color: "#FF6B00" }} viewBox="0 0 24 24"><circle cx="12" cy="12" r="4.6" fill="currentColor" /><g stroke="currentColor" strokeWidth="2.2" strokeLinecap="round"><path d="M12 1.8v2.4M12 19.8v2.4M1.8 12h2.4M19.8 12h2.4M4.6 4.6l1.7 1.7M17.7 17.7l1.7 1.7M19.4 4.6l-1.7 1.7M6.3 17.7l-1.7 1.7" /></g></svg>}
                        <div style={{ minWidth: 0 }}>
                          <div className="est-tag">{e.container === "reefer" ? "REEFER" : "DRY"}</div>
