    ...
    <>
      ...
      <section className="relative overflow-hidden py-20" style={{ background: "linear-gradient(135deg,#0B2D5C,#061A38 60%,#15448C)" }}>
        ...
        <div className="max-w-[1100px] mx-auto px-6 relative text-center">
          <div className="text-[11px] uppercase tracking-[0.22em] font-semibold text-white/70">Free verification tools</div>
          <h1 className="display text-white text-[40px] md:text-[58px] leading-[1.03] mt-3">Everything you need to<br />verify a shipment</h1>
          <p className="text-white/75 text-[16px] mt-5 max-w-xl mx-auto">A full toolkit for the supply chain — verify records, explore the chain, hash documents, and attach demurrage, fuel and emissions data, all in one place.</p>
        </div>
      </section>
