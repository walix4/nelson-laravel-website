  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden py-20" style={{ background: "linear-gradient(135deg,#0B2D5C,#061A38 60%,#15448C)" }}>
        <div className="absolute inset-0 opacity-50 pointer-events-none" style={{ background: "radial-gradient(700px 360px at 85% 0%,rgba(255,222,1,0.22),transparent 60%),radial-gradient(600px 360px at 10% 100%,rgba(58,95,192,0.3),transparent 60%)" }} />
        <div className="max-w-[1100px] mx-auto px-6 relative text-center">
          <div className="text-[11px] uppercase tracking-[0.22em] font-semibold text-white/70">Free compliance tools</div>
          <h1 className="display text-white text-[40px] md:text-[58px] leading-[1.03] mt-3">Everything you need to<br />clear an overweight load</h1>
          <p className="text-white/75 text-[16px] mt-5 max-w-xl mx-auto">A full toolkit for heavy freight — check gross and per-axle weight, the bridge formula, state permits and fees, route clearance and specs, all in one place.</p>
        </div>
      </section>
