...
const AC = [
  ...
  { n: "Single-trip permit", d: "One-time state authorization to run a load over legal weight on a defined route.", p: "$15–125" },
...
export default function Page() {
  ...
  return (
    <ToolLayout eyebrow="Reference" title="Overweight & Accessorial Glossary" desc="Every overweight and drayage line-item, in plain English — what it is, when it hits, and a typical U.S. range.">
