...
const AC = [
  ...
  { n: "QuickPay", d: "Early payment on an invoice in exchange for a small discount, instead of waiting full terms.", p: "1–3% disc." },
...
export default function Page() {
  ...
  return (
    <ToolLayout eyebrow="Reference" title="Payments & Accessorial Glossary" desc="Every drayage charge and payment term, in plain English — what it is, when it hits, and a typical U.S. range.">
      <div className="relative max-w-xl mx-auto mb-6 reveal">
        ...
        <input className="tool-input" style={{ paddingLeft: "2.8rem" }} placeholder="Search charges & terms…" value={q} onChange={(e) => setQ(e.target.value)} />
      </div>
