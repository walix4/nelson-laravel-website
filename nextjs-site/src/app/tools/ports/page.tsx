...
const COLOR: Record<string, string> = { West: "linear-gradient(160deg,#22D3EE,#3A5FC0)", East: "linear-gradient(160deg,#4C6FE0,#1E3A8A)", Gulf: "linear-gradient(160deg,#FB923C,#244a93)", Rail: "linear-gradient(160deg,#8B5CF6,#6D28D9)", Inland: "linear-gradient(160deg,#34D399,#059669)" };
