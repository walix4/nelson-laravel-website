...
export default function Page() {
  ...
  return (
    <ToolLayout title="Fuel Surcharge (FSC)" desc="Work out the per-mile fuel surcharge and total FSC for a move from the current diesel price, your base peg and truck MPG.">
