          ...
          <div className="grid lg:grid-cols-[1fr_1.1fr] gap-14 xl:gap-20 items-center">
            ...
            <div className="reveal">
              ...
              <div className="pt-8" style={{ borderTop: "1px solid rgba(255,255,255,0.06)" }}>
                ...
                <a href="mailto:info@draygo.net" className="group inline-flex items-center gap-3 transition-all" style={{ textDecoration: "none" }}>
            ...
            <div className="reveal reveal-delay-1">
              <div className="relative rounded-3xl p-8 md:p-10 overflow-hidden"
                ...
                {status === "success" ? (
                  <div className="flex flex-col items-center text-center py-10" style={{ animation: "fadeUp 0.4s ease both" }}>
