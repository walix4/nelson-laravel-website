...
export default function Pricing() {
  return (
    <>
      ...
      {/* HERO */}
      <section className="relative overflow-hidden text-white" style={{ background: "radial-gradient(900px 520px at 18% 18%,rgba(58,95,192,0.28),transparent 60%),radial-gradient(820px 520px at 86% 88%,rgba(255,222,1,0.22),transparent 60%),linear-gradient(180deg,#0B2D5C,#061A38)" }}>
