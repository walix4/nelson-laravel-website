    ...
    >
      ...
      >
        ...
        <div className="px-6 pt-6 pb-5 flex items-start justify-between" style={{ borderBottom: "1px solid rgba(255,255,255,0.08)" }}>
          ...
          {/* Square X button like reference */}
          <button
            onClick={onClose}
        ...
        <div className="px-6 py-7 text-center">
          ...
          <div className="w-14 h-14 rounded-2xl flex items-center justify-center mx-auto mb-5"
            style={{ background: "rgba(252,11,5,0.15)", border: "1px solid rgba(252,11,5,0.30)" }}>
    ...
    <button onClick={onClick}
      ...
      <div className="px-4 pt-3 pb-2">
        ...
        <div className="flex items-start justify-between gap-2">
          <div className="flex items-start gap-2.5 flex-1 min-w-0">
            <div className="shrink-0 mt-1">
              <div className="w-3 h-3 rounded-full border-[2.5px] border-[#3b82f6] bg-[#3b82f6]" />
            </div>
        ...
        <div className="flex items-start justify-between gap-2">
          <div className="flex items-start gap-2.5 flex-1 min-w-0">
            <div className="shrink-0 mt-1">
              <div className="w-3 h-3 rounded-full border-[2.5px] border-[#4ade80] bg-[#4ade80]" />
            </div>
            <div className="min-w-0">
      ...
      <div className="px-4 pb-3 pt-2">
        ...
        <div className="mt-2.5 h-[3px] rounded-full overflow-hidden" style={{ background: "rgba(255,255,255,0.07)" }}>
          <div className="h-full rounded-full transition-all" style={{ background: isHot ? "#fc0b05" : "#4ade80", width: isHot ? "72%" : "38%" }} />
        </div>
      </div>
